...
public class JavaHTTPServer {
	...
	static class MyHandler implements HttpHandler {
		...
		public void handle(HttpExchange t) {
			...
			/*
			 * Event event = null; try { event = new Event(json); } catch
			 * (HelloSignException e1) { // TODO Auto-generated catch block
			 * e1.printStackTrace();
			 * 
			 * }
			 */
			...
			/*
			 * try { if (event.isValid(apiKey)) { System.out.print("Event received:"); if
			 * (event.hasAccountId()) { System.out.print("\tAccount ID: " +
			 * event.getAccountId()); } DateFormat dateformat =
			 * DateFormat.getDateTimeInstance();
			 * dateformat.setTimeZone(TimeZone.getTimeZone("US/Pacific"));
			 * System.out.print("\tDate: " + dateformat.format(event.getEventDate()));
			 * System.out.print("\tType: " + event.getType()); if
			 * (event.hasSignatureRequest()) { System.out.print("\tSignature Request: " +
			 * event.getSignatureRequest().getId()); } if (event.hasRelatedSignatureId()) {
			 * System.out.print("\tSignature ID: " + event.getRelatedSignatureId()); } }
			 * }catch (HelloSignException e) { // TODO Auto-generated catch block
			 * e.printStackTrace(); }
			 */
		}
